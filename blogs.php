    ...
    <div class="container">
        <div class="row align-items-center position-relative">
            ...
            <div class="col-lg-5 d-none d-lg-block" >
                <img src="assets/images/blog-banner-img.webp" loading="lazy" class="contact-banner-img img-fluid" width="" height="" alt="" data-aos="fade-up" data-aos-delay="600"/>
            </div>
        </div>
    </div>
</section>
<section class="contact_us blogs">
    <div class="container">
        ...
        <h2 class="heading70px text-center dark m-0">
            ...
            Our <span class="secondColor">Blogs</span>
            </span></span>
        </h2>
        ...
        <div class="row mt-4 g-0">
            <div class="col-lg-4 p-2 aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                <div class="ow_row">
                    <img src="assets/images/blog-img.webp" loading="lazy" class="ow_img img-fluid" width="616" height="377" alt="AppVerra" loading="lazy">
            ...
            <div class="col-lg-4 p-2 aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
                <div class="ow_row">
                    <img src="assets/images/blog-img.webp" loading="lazy" class="ow_img img-fluid" width="616" height="377" alt="AppVerra" loading="lazy">
                    <div class="p-3 p-lg-4">
